...
router.get('',verifyToken,async (req,res)=>{
    ...
    let enfants = await Enfant.find().populate('classe')
...
router.get('/:id',verifyToken,async (req,res)=>{
    let enfant = await Enfant.findById(req.params.id).populate('classe')//.populate('role').populate('directeur.etablissement').populate('classe');
...
router.post('',verifyToken,async (req,res)=>{
    ...
    let enfant = await new Enfant(_.pick(req.body, ['nom', 'prenom', 'dateNaissance', 'adresse', ,'classe','directeur']))
